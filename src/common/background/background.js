    ...
    useEffect(() => {
        ...
        function init() {
            ...
            if ('ontouchstart' in document.documentElement && window.DeviceOrientationEvent) {
                window.addEventListener('deviceorientation', function (e) {
                    mouse.x = (canvas.clientWidth / 3) - ((e.gamma / 90) * (canvas.clientWidth / 2) * 2);
                    mouse.y = (canvas.clientHeight / 3) - ((e.beta / 90) * (canvas.clientHeight / 2) * 2);
                }, false);
            } else {
                // Mouse move listener
        ...
        Particle.prototype.render = function () {
            ...
            if (renderParticleGlare) {
                ...
                // context.ellipse(pos.x, pos.y, r * 100, r, -60 * (Math.PI / 180), 0, 2 * Math.PI, false);
                // context.fill();
                // context.closePath();
                context.ellipse(pos.x, pos.y, r * 120, r, (glareAngle - ((nPos.x - 0.5) * noiseStrength * motion)) * (Math.PI / 180), 0, 2 * Math.PI, false);
                context.fill();
                context.closePath();
            }
